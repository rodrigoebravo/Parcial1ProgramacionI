 ...
 * ademas un valor criterio, acumulando lo que devuelva esta ultima funcion en una variable para retornar cuando termine la iteracion.
 * \param this LinkedList* Puntero a la lista
 * \param int func(void*) Puntero a la funcion criterio
...
int ll_count(LinkedList* this, int (*func)(void*, void*), void* valorCriterio)
{
    ...
    if(this!=NULL && func!=NULL)
    {
        ...
        {
            do{
                acumuladorSegunFunc+=func(pNodeAux->pElement, valorCriterio);
                pNodeAux=ll_getNextNode(this);
            }while(pNodeAux!=NULL);
        }
    }
    return acumuladorSegunFunc;
}
