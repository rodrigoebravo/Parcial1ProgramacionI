...
void Feed_printFeed(Feed* this)
{
    ...
    if(this!=NULL &&
       Feed_getIdPublicacion(this, &idPublicacionAux)==TODOOK &&
       Feed_getIdUsuario(this, &idUsuarioAux)==TODOOK &&
       Feed_getLikesPublicacion(this, &likesPublicacionAux)==TODOOK &&
       Feed_getLikesUsuario(this, &likesUsuarioAux)==TODOOK &&
       Feed_getMsg(this, msgAux)==TODOOK &&
       Feed_getNick(this, nickAux)==TODOOK)
    {
        printf("ID_MENSAJE: %d MENSAJE: Hello world POPULARIDAD_MENSAJE: %d ID_USUARIO: %d NICK: %s POPULARIDAD_USUARIO: %d\n",
               idPublicacionAux, likesPublicacionAux, idUsuarioAux, nickAux, likesUsuarioAux);
    }
}
