 ...
 */
LinkedList* ll_filter(LinkedList* this, int (*func)(void*, void*), void* valor)
{
    ...
    if(this!=NULL && func!=NULL)
    {
        ...
        for(i=0;i<this->size;i++)
        {
            ...
            if(pElement!=NULL && func(pElement, valor))
                ll_add(pThisReturn, pElement);
        }
    }
    return pThisReturn;
}

/**\brief Inicia iteracion: Asigna al nodo pIteratorNode, variable de la estructura LinkedList, el primer valor de la lista LinkedList a iterar.
 * \param this LinkedList* Puntero a la lista
...
/** \brief Asigna al nodo pIteratorNode, variable de la estructura LinkedList, el siguiente valor al que encuentra en pIteratorNode
 * \param this LinkedList* Puntero a la lista
 * \return void* el siguiente Nodo encontrado o NULL
 */
void* ll_getNextNode(LinkedList* this)
{
    ...
    if(this!=NULL)
    {
        pNode=this->pIteratorNode;
        this->pIteratorNode=pNode->pNextNode;
        return this->pIteratorNode;
    }
    return NULL;
}

/** \brief Recorre la lista nodo a nodo, pasando cada elemento de cada nodo por parametro a la funcion que recibe como parametro.
 * \param this LinkedList* Puntero a la lista
 * \param int func(void*) Puntero a la funcion criterio
 */
...
/** \brief Recorre la lista nodo a nodo, la "func()" pasandole cada elemento del nodo encontrado en la iteracion,
 * \param this LinkedList* Puntero a la lista
 * \param int func(void*) Puntero a la funcion criterio, devuelve entero que se acumulará.
 * \param void* valorCriterio Puntero al valor criterio
 * \return int contadorSegunFunc acumulador en la iteracion
 */
int ll_count(LinkedList* this, int (*fn)(void*))
{
    ...
    if(this!=NULL && fn!=NULL)
    {
        ...
        {
            do{
                contadorSegunFunc+=fn(pNodeAux->pElement);
                pNodeAux=ll_getNextNode(this);
            }while(pNodeAux!=NULL);
        }
    }
...
*   \brief Recorre this, pasando cada elemento y el valor a func
*/
int ll_MapperConValores(LinkedList* this, int func(void*, void*, void*), void* valorA, void* valorB)
{
    Node* pNodeAux;
    int retorno=ERROR;
    if(this!=NULL && func!=NULL && valorA!=NULL && valorB!=NULL)
    {
        retorno=TODOOK;
        pNodeAux=ll_startIteration(this);
        if(pNodeAux!=NULL)
        {
            do{
                func(pNodeAux->pElement, valorA, valorB);
                pNodeAux=ll_getNextNode(this);
            }while(pNodeAux!=NULL);
        }
    }
