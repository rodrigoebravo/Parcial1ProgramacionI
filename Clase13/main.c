...
A. Realizar un solo listado de las pantallas
     ordenadas por los siguientes criterios:
...
int main()
{
    ...
    pantalla_altaForzada(array,QTY,"Ailde","Las Flores 50",50,0);
    pantalla_altaForzada(array,QTY,"Rilde","Las Flores 50",50,0);
    ...
    do
    {
        ...
        switch(menu)
        {
            ...
            case 7:
                ...
                break;
            case 8:
                pan_printPantallaOrdenadaPrecioNombre(array, QTY);
                break;
            case 9:
                //1  <
                //2  >
                ...
                pan_getPorCriterio(array, QTY, 5, 10);
                break;
